...
// Daftar putih field yang boleh dipakai untuk mengurutkan (sort).
...
func parseListQuery(c *fiber.Ctx) ListQuery {
	...
	// Batas atas limit untuk mencegah kehabisan memori. Saya tentukan 100 sebagai default aman.
	if q.Limit > 100 {
		q.Limit = 100
	}
	// Daftar putih (whitelist), mencegah error jika field tidak ada
